...
class PortfolioApp:
    ...
    def __init__(self):
        ...
        self.sub_date_1 = datetime.datetime(2024, 4, 1)
        ...
        self.initial_portfolio = ['AAPL', 'TSLA', 'MSFT', 'AMZN', 'META', 'V', 'NOW', 'NVDA', 'PYPL', 'INTC', 'GOOG', 'CVS', 'JNJ', 'CNSWF', 'LRCX', 'ABNB', 'BRK-B', 'MKL', 'ABT', 'BABA']
        self.rev1_portfolio = ['AAPL', 'TSLA', 'MSFT', 'AMZN', 'META', 'V', 'NOW', 'NVDA', 'PYPL', 'INTC', 'GOOG', 'CVS', 'JNJ', 'CRM', 'LRCX', 'ABNB', 'BRK-B', 'MKL', 'ABT', 'BABA']
        self.rev2_portfolio = ['AAPL', 'TSLA', 'MSFT', 'AMZN', 'META', 'V', 'NOW', 'NVDA', 'PYPL', 'INTC', 'GOOG', 'CVS', 'JNJ', 'CRM', 'LRCX', 'YELP', 'BRK-B', 'MKL', 'ABT', 'BABA']
    ...
    def run(self):
        ...
        with col2:
            ...
            st.line_chart(performance_table)
        ...
        with tab1:
            ...
            st.write("This is the current iteration of the portfolio which began on 5/16/2024. This 3rd iteration consisted of swapping out **ABNB** with **YELP**.")
            self.make_tabs(self.portfolio_3, self.sub_date_2, self.selected_date)
        with tab2:
            st.header("Original Portfolio")
            st.write("This is the first iteration of the portfolio which existed from the beginning of the year until 4/1/2024.")
        ...
        with tab3:
            ...
            st.write("This is the second iteration of the portfolio which existed from 4/1/2024 to 7/1/2024 and saw the substitution of **CNSWF** with **CRM***.")
